...
set
 ...
 "options" = '{"choices":[{"text":"Sim/Não","value":"yesno"},{"text":"Texto livre (apenas twitter)","value":"text"},{"text":"Grupo de Sim/Não","value":"yesnogroup"},{"text":"Lista de skill (apenas app)","value":"skillset"},{"text":"Botão modo camuflado","value":"botao_tela_modo_camuflado"},{"text":"Apenas Exibir texto","value":"displaytext"},{"text":"Botão de finalizar","value":"botao_fim"},{"text":"Lista de opção (selecionar uma)","value":"onlychoice"},{"text":"Exibir resultados da busca de ponto apoio","value":"ponto_apoio_results"},{"text":"Busca de cep","value":"cep_address_lookup"}]}',
 display_options = '{"choices":[{"text":"Sim/Não","value":"yesno"},{"text":"Texto livre","value":"text"},{"text":"Grupo de Sim/Não","value":"yesnogroup"},{"text":"Lista de skill","value":"skillset"},{"text":"Botão modo camuflado","value":"botao_tela_modo_camuflado"},{"text":"Exibir texto","value":"displaytext"},{"text":"Botão de finalizar","value":"botao_fim"},{"text":"Exibir resultados da busca de ponto apoio","value":"ponto_apoio_results"},{"text":"Busca de cep","value":"cep_address_lookup"},{"text":"Lista de opção (selecionar uma)","value":"onlychoice"}]}'
