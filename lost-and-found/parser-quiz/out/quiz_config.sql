...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        12, '["Olá, bem-vinda ao Manual de Fuga do PenhaS. Esse recurso vai ajudá-la a criar um plano de fuga do ambiente doméstico, minimizando riscos decorrentes de uma situação de violência.","A finalidade deste manual é construir junto contigo as melhores estratégias de segurança pessoal e lhe informar sobre os direitos que você possui caso precise fugir de casa para se proteger. ","Sabemos que esse momento não é fácil e por isso estamos aqui para que você se sinta acolhida e segura para seguir em frente, qualquer que seja a decisão!","Cada situação é diferente e somente você pode avaliar o risco que corre. Quanto mais perguntas você responder no Manual de Fuga, mais personalizado ele se torna para você. Vamos juntas?"]', '1', 'null',
                        '[{"label":"Passos para fuga","value":"passos-para-fuga"},{"label":"Crianças, adolescentes e dependentes","value":"criancas-adolescentes-e-dependentes"},{"label":"Bens, trabalho e renda","value":"bens-trabalho-e-renda"},{"label":"Segurança pessoal","value":"seguranca-pessoal"},{"label":"Transporte","value":"transporte"}]', '[["T1","T2","T3","T4"]]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10001000, 'autocontinue', 'B0_p0a', E'',
                        12, '[]', 'B0_P0 == \'passos-para-fuga\'', 'null',
                        'null', '[]', 13);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10002000, 'autocontinue', 'B0_p0b', E'',
                        12, '[]', 'B0_P0 == \'criancas-adolescentes-e-dependentes\'', 'null',
                        'null', '[]', 14);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10003000, 'autocontinue', 'B0_p0c', E'',
                        12, '[]', 'B0_P0 == \'bens-trabalho-e-renda\'', 'null',
                        'null', '[]', 15);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10004000, 'autocontinue', 'B0_p0d', E'',
                        12, '[]', 'B0_P0 == \'seguranca-pessoal\'', 'null',
                        'null', '[]', 16);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10005000, 'autocontinue', 'B0_p0e', E'',
                        12, '[]', 'B0_P0 == \'transporte\'', 'null',
                        'null', '[]', 17);
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P2 == \'Y\'', 'null',
                        '[{"label":"Auxílio-aluguel","value":"auxilio-aluguel"},{"label":"Casa abrigo","value":"casa-abrigo"},{"label":"Casa de acolhimento","value":"casa-de-acolhimento"}]', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P3 == \'casa-de-acolhimento\' ', 'null',
                        'null', '[{"codigo":"T5"},{"codigo":"T6"},{"codigo":"T7"},{"codigo":"T8"}]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10010070, 'yesno', 'B1_P4', E'Quer saber se em seu estado/cidade há alguns desses serviços?',
                        13, '[]', 'B1_P3 == \'auxilio-aluguel\' || B1_P3 == \'casa-abrigo\' || B1_P3 == \'casa-de-acolhimento\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P1 == \'Y\'', 'null',
                        '[{"label":"Casa de uma amiga ou vizinha","value":"casa-de-uma-amiga-ou-vizinha"},{"label":"Casa de um familiar","value":"casa-de-um-familiar"},{"label":"Casa-abrigo ou casa de Acolhimento","value":"casa-abrigo-ou-casa-de-acolhimento"},{"label":"Uma nova casa Alugada","value":"uma-nova-casa-alugada"}]', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P5 == \'casa-de-uma-amiga-ou-vizinha\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P5 == \'casa-de-um-familiar\' ', 'null',
                        'null', '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T12"},{"codigo":"T13"}]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P5 == \'casa-abrigo-ou-casa-de-acolhimento\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P5 == \'uma-nova-casa-alugada\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P6 == \'casa-de-uma-amiga-ou-vizinha\' ', 'null',
                        'null', '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T12"},{"codigo":"T13"}]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10013220, 'displaytext', 'B1_P6_R11', E'Que bom que tem com quem contar, isso ajuda muito e faz com que tenhamos a certeza de que não estamos sozinhas! Lembre-se que é importante que você não vá para um lugar tão óbvio e que tome todas as medidas de segurança necessárias, para que nem você, nem a pessoa que te acolheu fique em risco.',
                        13, '[]', 'B1_P6 == \'casa-de-um-familiar\' ', 'null',
                        'null', '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T12"},{"codigo":"T13"}]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P6 == \'casa-abrigo-ou-casa-de-acolhimento\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P6 == \'uma-nova-casa-alugada\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P5 == \'casa-de-uma-amiga-ou-vizinha\' || B1_P5 == \'casa-de-um-familiar\' || B1_P5 == \'casa-abrigo-ou-casa-de-acolhimento\' || B1_P5 == \'uma-nova-casa-alugada\' || B1_P6 == \'casa-de-uma-amiga-ou-vizinha\' || B1_P6 == \'casa-de-um-familiar\' || B1_P6 == \'casa-abrigo-ou-casa-de-acolhimento\' || B1_P6 == \'uma-nova-casa-alugada\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        13, '[]', 'B1_P7 == \'Y\' || B1_P7 == \'N\' || B1_P7 == \'M\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10016310, 'autocontinue', 'B1_P8ac', E'',
                        13, '[]', 'B1_P8 == \'Y\' || B1_P8 == \'N\'', 'null',
                        'null', '[]', 17);
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P11 == \'Y\'', 'null',
                        '[{"label":"Meu filho ou filha","value":"meu-filho-ou-filha"},{"label":"Meu enteado ou enteada","value":"meu-enteado-ou-enteada"},{"label":"Outras relações","value":"outras-relacoes"}]', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P12 == \'meu-filho-ou-filha\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P12 == \'meu-enteado-ou-enteada\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P12 == \'outras-relacoes\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P12 == \'meu-filho-ou-filha\' || B2_P12 == \'meu-enteado-ou-enteada\' || B2_P12 == \'outras-relacoes\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P13 == \'Y\' || B2_P13 == \'N\' || B2_P13 == \'M\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        14, '[]', 'B2_P11 == \'N\' || B2_P15 == \'Y\' || B2_P15 == \'N\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P19 == \'trabalho-e-tenho-liberdade-com-o-meu-dinheiro\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P19 == \'nao-trabalho-mas-recebo-beneficio-ou--pensao\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P19 == \'dependo-financeiramente-ou--ele-controla-meu-dinheiro\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P20 == \'o-imovel-e-proprio-ou-alugado-em-nome-do-agressor\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P20 == \'o-imovel-e-alugado-no-meu-nome\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P20 == \'o-imovel-e-financiado-no-nome-dos-dois\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        15, '[]', 'B3_P20 == \'construimos-um-imovel-no-terreno-da-familia\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P21 == \'N\' || B4_P23 == \'Y\' || B4_P23 == \'N\'', 'null',
                        '[{"label":"Sim, tenho medida protetiva","value":"sim-tenho-medida-protetiva"},{"label":"Já denunciei, mas não tenho medida protetiva.","value":"ja-denunciei-mas-nao-tenho-medida-protetiva"},{"label":"Nunca denunciei","value":"nunca-denunciei"}]', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P24 == \'sim-tenho-medida-protetiva\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P24 == \'ja-denunciei-mas-nao-tenho-medida-protetiva\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P24 == \'nunca-denunciei\' ', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P24 == \'sim-tenho-medida-protetiva\' || B4_P24 == \'ja-denunciei-mas-nao-tenho-medida-protetiva\' || B4_P24 == \'nunca-denunciei\'', 'null',
                        '[{"label":"Sim, a atividade profissional autoriza a posse","value":"sim-a-atividade-profissional-autoriza-a-posse"},{"label":"Sim, mas não sei a procedência e/ou não é registrada","value":"sim-mas-nao-sei-a-procedencia-e_ou-nao-e-registrada"},{"label":"Não/Não sei","value":"nao-ou-nao-sei"}]', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P25 == \'sim-a-atividade-profissional-autoriza-a-posse\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P25 == \'sim-mas-nao-sei-a-procedencia-e_ou-nao-e-registrada\' ', 'null',
                        'null', '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T126"}]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        16, '[]', 'B4_P25 == \'nao-ou-nao-sei\' ', 'null',
                        'null', '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T126"}]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10039170, 'yesno', 'B4_P26', E'Você possui alguma deficiência física e/ou intelectual?',
                        16, '[]', 'B4_P25 == \'sim-a-atividade-profissional-autoriza-a-posse\' || B4_P25 == \'sim-mas-nao-sei-a-procedencia-e_ou-nao-e-registrada\' || B4_P25 == \'nao-ou-nao-sei\'', 'null',
                        'null', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        17, '[]', '1', 'null',
                        '[{"label":"Transporte público","value":"transporte-publico"},{"label":"Moto/ Carro próprio","value":"moto-ou--carro-proprio"},{"label":"Carona","value":"carona"},{"label":"Bicicleta/a pé","value":"bicicleta-ou-a-pe"},{"label":"Táxi ou carro por aplicativo","value":"taxi-ou-carro-por-aplicativo"},{"label":"Não sei","value":"nao-sei"}]', '[]', null);
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        VALUES ('published', 10018320, 'displaytext', 'B5_P9_R19', E'',
                        17, '[]', 'B5_P9 == \'transporte-publico\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        17, '[]', 'B5_P9 == \'moto-ou--carro-proprio\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        17, '[]', 'B5_P9 == \'bicicleta-ou-a-pe\' ', 'null',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id)
                        ...
                        17, '[]', 'B5_P9 == \'taxi-ou-carro-por-aplicativo\' ', 'null',
