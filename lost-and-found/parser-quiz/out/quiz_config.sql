...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10006020, 'displaytext', 'B1_P1_R1', E'Fique calma! Há outras possibilidades. Existem casas de acolhimento e casas-abrigo para mulheres em situação de violênca em alguns municípios. Também há a alternativa do recebimento do auxílio-aluguel.',
                        13, E'[]', E'B1_P1 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10006030, 'displaytext', 'B1_P1_R10', E'Que bom que você talvez tenha algum lugar seguro para ir após a fuga, mas é imporrtante estar certa dessa alternativa.',
                        13, E'[]', E'B1_P1 == \'M\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10013290, 'displaytext', 'B1_P7_R17', E'Ótimo, mantenha a calma! Sabemos que é um momento extremamente delicado e que envolve muita coisa, mas lembre-se estamos nessa luta juntas para que você possa ter o direito de viver uma vida livre de violência! Continue firme!',
                        13, E'[]', E'B1_P7 == \'Y\' ', null,
                        null, '[{"codigo":"T17"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10013300, 'displaytext', 'B1_P7_R18', E'Isso é um sinal de que precisamos redobrar os cuidados! Continue a sua rotina normal para que não gere mais desconfianças.',
                        13, E'[]', E'B1_P7 == \'N\' ', null,
                        null, '[{"codigo":"T17"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10018440, 'displaytext', 'B2_P10intro', E'Neste bloco, vamos tratar sobre crianças, adolescentes e outras pessoas que dependam de seus cuidados e vivam no mesmo ambiente doméstico que você. O foco aqui é garantir que essas pessoas estejam protegidas e possam lhe ajudar quando possível, entendendo que é importante que as crianças e os adolescentes sejam orientados a pedir ajuda, mas não devem se sentir responsáveis por garantir sua proteção para que isso não gere impactos negativos na saúde mental deles futuramente. Então, as perguntas e orientações que faremos aqui serão no intuito de criar um ambiente seguro e garantir direitos para todos vocês antes, durante e depois do plano de fuga.',
                        14, E'[]', E'1', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10019440, 'yesno', 'B2_P10', E'Deseja responder esse bloco?',
                        14, E'[]', E'1', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10020440, 'yesno', 'B2_P11', E'Há criança e/ou adolescente no ambiente doméstico?',
                        14, E'[]', E'B2_P10 == \'Y\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10020450, 'displaytext', 'B2_P11_R29', E'Lamento que tenha que lidar com mais essa situação. Vamos juntas encontrar uma maneira de deixá-los em segurança. É importante ter em mente que mesmo que eles não sejam alvo direto das ameaças ou das agressões físicas, um ambiente doméstico violento é prejudicial a todos.',
                        14, E'[]', E'B2_P11 == \'Y\' ', null,
                        null, '[{"codigo":"T12"},{"codigo":"T49"},{"codigo":"T50"},{"codigo":"T51"},{"codigo":"T52"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10020460, 'displaytext', 'B2_P11_R30', E'Está bem. Sendo assim, vamos dar continuidade.ao seu plano de fuga.',
                        14, E'[]', E'B2_P11 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021460, 'onlychoice', 'B2_P12', E'Quem é a criança e/ou adolescente?',
                        14, E'[]', E'B2_P11 == \'Y\'', null,
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021470, 'displaytext', 'B2_P12_R31', E'Acolha, proteja e converse o máximo possível, de acordo com suas possibilidades. Se esse agressor é o pai, a depender da idade, essa criança e/ou adolescente pode estar em intenso conflito emocional.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021490, 'displaytext', 'B2_P12_R33', E'É provável que você já tenha construído uma relação de afeto com essa criança e/ou adolescente. Acolha, proteja e converse o máximo possível, de acordo com suas possibilidades.',
                        14, E'[]', E'B2_P12 == \'meu-enteado-ou-enteada\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021500, 'displaytext', 'B2_P12_R34', E'Se tiver oportunidade, busque contato com outros familiares, que possam proteger ou acolher temporariamente essa criança/adolescente. Se possível, mantenha com você os documentos da criança e/ou adolescente.',
                        14, E'[]', E'B2_P12 == \'meu-enteado-ou-enteada\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021510, 'displaytext', 'B2_P12_R35', E'Ao sair de casa, denuncie o agressor e faça um boletim de ocorrência frisando o risco que a criança e/ou o adolescente está correndo e que ele também é vítima de violência e está em risco. Infelizmente, nosso sistema judiciário ainda é muito machista e misógino, então é preciso que você se resguarde ao máximo.',
                        14, E'[]', E'B2_P12 == \'meu-enteado-ou-enteada\' ', null,
                        null, '[{"codigo":"T53"},{"codigo":"T55"},{"codigo":"T61"},{"codigo":"T62"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021520, 'displaytext', 'B2_P12_R36', E'Acolha, proteja e converse o máximo possível, de acordo com suas possibilidades. Busque o Conselho Tutelar da sua cidade para conhecer as maneiras de ajudar essa criança e/ou adolescente sem se expor ainda mais à violência.',
                        14, E'[]', E'B2_P12 == \'outras-relacoes\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10021530, 'displaytext', 'B2_P12_R37', E'Saiba, desde já, que é possível fazer denúncia anônima. Se tiver oportunidade, busque contato com outros familiares, que possam proteger ou acolher temporariamente essa criança/adolescente. Se possível, mantenha com você os documentos dele(a).',
                        14, E'[]', E'B2_P12 == \'outras-relacoes\' ', null,
                        null, '[{"codigo":"T53"},{"codigo":"T55"},{"codigo":"T61"},{"codigo":"T62"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10022530, 'yesnomaybe', 'B2_P13', E'Você pretende incluir essa criança e/ou adolescente em seu plano de fuga?',
                        14, E'[]', E'B2_P12 == \'meu-filho-ou-filha\' || B2_P12 == \'meu-enteado-ou-enteada\' || B2_P12 == \'outras-relacoes\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10022540, 'displaytext', 'B2_P13_R38', E'Entendo sua decisão! Esse é um momento bastante delicado e você talvez seja a única fonte de segurança dessa criança e/ou adolescente. Sigamos juntas!',
                        14, E'[]', E'B2_P13 == \'Y\' ', null,
                        null, '[{"codigo":"T63"},{"codigo":"T64"},{"codigo":"T65"},{"codigo":"T66"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10022550, 'displaytext', 'B2_P13_R39', E'Compreendo e acolho sua decisão! Esse é um momento delicado, em que é preciso muita cautela. Sair do ambiente violento e se fortalecer pode ser o primeiro passo para, mais tarde, também proporcionar segurança a quem depende de você. Siga com seu plano.',
                        14, E'[]', E'B2_P13 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10022560, 'displaytext', 'B2_P13_R40', E'Não se sinta culpada em deixar a criança e/ou adolescente. Você está fazendo o possível e isso é proteção. Você tem sido muito forte!',
                        14, E'[]', E'B2_P13 == \'N\' ', null,
                        null, '[{"codigo":"T63"},{"codigo":"T67"},{"codigo":"T68"},{"codigo":"T69"},{"codigo":"T70"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10022570, 'displaytext', 'B2_P13_R41', E'Tudo bem, esse é um momento delicado, em que é muito comum ter dúvidas do que fazer. Continue com seu plano. Estamos à disposição, por meio do nosso suporte, para, a qualquer momento, dialogar sobre esse assunto em específico. Retorne quando se sentir mais segura.',
                        14, E'[]', E'B2_P13 == \'M\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10022575, 'tag_user', 'B2_P13_tags', E'',
                        14, E'[]', E'B2_P13 == \'M\' ', null,
                        null, '[]', null, '[{"codigo":"T2"}]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10023570, 'yesno', 'B2_P14', E'A criança e/ou adolescente sabe da sua intenção de fuga?',
                        14, E'[]', E'B2_P13 == \'Y\' || B2_P13 == \'N\' || B2_P13 == \'M\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10023580, 'displaytext', 'B2_P14_R42', E'A depender da idade e da linguagem, a criança e/ou adolescente é, sim, capaz de compreender a necessidade e a forma como se dará a saída do ambiente familiar. Dialogue sempre que possível e, com muito cuidado, ajuste as fantasias e expectativas da criança e/ou adolescente à realidade.',
                        14, E'[]', E'B2_P14 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10023590, 'displaytext', 'B2_P14_R43', E'Mas também é importante ter cautela para não colocar o plano em risco. Crianças e/ou adolescentes são mais vulneráveis a pressões e ameaças.',
                        14, E'[]', E'B2_P14 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10023600, 'displaytext', 'B2_P14_R44', E'Somente compartilhe o plano no momento em que você tiver segurança quanto à sua concretização. A sensação de segurança nas crianças e/ou adolescentes requer algum grau de previsibilidade.',
                        14, E'[]', E'B2_P14 == \'Y\' ', null,
                        null, '[{"codigo":"T71"},{"codigo":"T72"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10023610, 'displaytext', 'B2_P14_R45', E'A sensação de segurança nas crianças e/ou adolescentes requer algum grau de previsibilidade. Recomendamos que compartilhe o plano no momento em que você tiver segurança quanto à sua concretização.',
                        14, E'[]', E'B2_P14 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10023620, 'displaytext', 'B2_P14_R46', E'Dialogue sempre que possível e, com muito cuidado, ajuste as fantasias e expectativas da criança e/ou adolescente à realidade. Quando se sentir segura para compartilhar, busque adaptar a linguagem à idade.',
                        14, E'[]', E'B2_P14 == \'N\' ', null,
                        null, '[{"codigo":"T71"},{"codigo":"T72"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10024620, 'yesno', 'B2_P15', E'A criança e/ou adolescente possui alguma condição especial de saúde, limitação física e/ou intelectual?',
                        14, E'[]', E'B2_P14 == \'Y\' || B2_P14 == \'N\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10024630, 'displaytext', 'B2_P15_R47', E'Neste caso, além da preparação de documentos, é importante ficar atenta à rotina de medicações, atendimentos médicos e tudo o quanto for necessário para a convivência com a condição.',
                        14, E'[]', E'B2_P15 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10024640, 'displaytext', 'B2_P15_R48', E'A depender da situação, você pode necessitar de mais ajuda antes, durante e depois da fuga. Avalie quem pode estar com você ao longo do processo - veja orientações no bloco \'Passos para a fuga\').',
                        14, E'[]', E'B2_P15 == \'Y\' ', null,
                        null, '[{"codigo":"T73"},{"codigo":"T74"},{"codigo":"T75"},{"codigo":"T76"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10024650, 'displaytext', 'B2_P15_R49', E'Muito bem. Já estamos finalizando este bloco. Siga com o plano.',
                        14, E'[]', E'B2_P15 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10025650, 'yesno', 'B2_P16', E'Há outro adulto e/ou idoso submetido a alguma forma de violência?',
                        14, E'[]', E'B2_P11 == \'N\' || B2_P15 == \'Y\' || B2_P15 == \'N\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10025660, 'displaytext', 'B2_P16_R50', E'Este plano de fuga é individual e focado em sua própria segurança. Certifique-se se é seguro dividir estratégias ou mesmo incluir mais alguém nele.',
                        14, E'[]', E'B2_P16 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10025670, 'displaytext', 'B2_P16_R51', E'Se julgar isso essencial, converse e conte para essa pessoa os itens listados ao final do seu plano.',
                        14, E'[]', E'B2_P16 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10025680, 'displaytext', 'B2_P16_R52', E'Compartilhe informações sobre como denunciar, solicitar medida protetiva e onde encontrar orientações que possam ajudar a romper o ciclo de violência. Ela também pode criar o próprio plano de fuga aqui no PenhaS.',
                        14, E'[]', E'B2_P16 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10025690, 'displaytext', 'B2_P16_R53', E'Você acabou de finalizar este bloco. Parabéns! Obrigada por ter respondido até aqui. Você é forte e corajosa! O PenhaS quer te ajudar a romper com o ciclo de violência. Certifique-se de todos os itens que aparecerão no seu plano. Eles são personalizados a partir de suas respostas, por isso é tão importante que você responda a todos os blocos.',
                        14, E'[]', E'B2_P16 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10026690, 'yesno', 'B2_P17', E'A pessoa reconhece que também é vítima de violência?',
                        14, E'[]', E'B2_P16 == \'Y\' || B2_P16 == \'N\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10026700, 'displaytext', 'B2_P17_R54', E'Se estiver diante de outras mulheres vítimas de violência, oriente-nas a buscarem uma medida protetiva contra o agressor, assim como cadastrar-se ou atualizar o Cadastro Único (CadÚnico) e levar ao CRAS toda documentação necessária, dela e de filhos, se houver.',
                        14, E'[]', E'B2_P17 == \'Y\' ', null,
                        null, '[{"codigo":"T77"},{"codigo":"T78"},{"codigo":"T79"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10026710, 'displaytext', 'B2_P17_R55', E'Você também pode fazer uma denúncia. É dever de todos denunciar casos de violência à polícia, ao Ministério Público, à Justiça ou outro órgão de proteção às mulheres. Lembre-se que a denúncia pode ser feita de forma anônima.',
                        14, E'[]', E'B2_P17 == \'Y\' ', null,
                        null, '[{"codigo":"T77"},{"codigo":"T78"},{"codigo":"T79"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10026720, 'displaytext', 'B2_P17_R54', E'Se estiver diante de outras mulheres vítimas de violência, oriente-nas a buscarem uma medida protetiva contra o agressor, assim como cadastrar-se ou atualizar o Cadastro Único (CadÚnico) e levar ao CRAS toda documentação necessária, dela e de filhos, se houver.',
                        14, E'[]', E'B2_P17 == \'N\' ', null,
                        null, '[{"codigo":"T77"},{"codigo":"T78"},{"codigo":"T79"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10026730, 'displaytext', 'B2_P17_R55', E'Você também pode fazer uma denúncia. É dever de todos denunciar casos de violência à polícia, ao Ministério Público, à Justiça ou outro órgão de proteção às mulheres. Lembre-se que a denúncia pode ser feita de forma anônima.',
                        14, E'[]', E'B2_P17 == \'N\' ', null,
                        null, '[{"codigo":"T77"},{"codigo":"T78"},{"codigo":"T79"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10027730, 'yesno', 'B2_P18', E'A pessoa tem condições físicas, pisíquicas e/ou emocionais para buscar ajuda?',
                        14, E'[]', E'B2_P17 == \'Y\' || B2_P17 == \'N\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10027740, 'displaytext', 'B2_P18_R56', E'Sabemos que reconhecer a violência é apenas o primeiro passo. Sempre que possível, compartilhe informações úteis e incentive outras vítimas a romper o ciclo de violência.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10027760, 'displaytext', 'B2_P18_R59', E'Você acabou de finalizar este bloco. Parabéns! Obrigada por ter respondido até aqui. Você é forte e corajosa! O PenhaS quer te ajudar a romper com o ciclo de violência. Certifique-se de todos os itens que aparecerão no seu plano. Eles são personalizados a partir de suas respostas, por isso é tão importante que você responda a todos os blocos.',
                        14, E'[]', E'B2_P18 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10027780, 'displaytext', 'B2_P18_R58', E'Sempre que possível, compartilhe informações úteis e incentive outras vítimas a romper o ciclo de violência.',
                        14, E'[]', E'B2_P18 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10029790, 'onlychoice', 'B3_P19', E'Você possui renda?',
                        15, E'[]', E'1', null,
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10029800, 'displaytext', 'B3_P19_R60', E'Que bom! Ter autonomia financeira é essencial na quebra do ciclo de violência. Vamos incluir no seu guia algumas orientações importantes para ajudar a planejar a fuga com segurança que você terá acesso após responder aos blocos.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10029810, 'displaytext', 'B3_P19_R61', E'Que bom! Ter autonomia financeira é um ponto importante na quebra do ciclo de violência. Saiba que é um direito seu ter esse acesso ao auxílio.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030820, 'onlychoice', 'B3_P20', E'O imóvel que você mora é próprio ou alugado?',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030830, 'displaytext', 'B3_P20_R63', E'Neste caso, você pode procurar uma delegacia, de preferência especializada no atendimento às mulheres, e solicitar uma medida protetiva para que o agressor seja afastado do ambiente doméstico e de você.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030850, 'displaytext', 'B3_P20_R65', E'Deixar o lar não invalida sua propriedade patrimonial ou o direito à guarda de filhos, caso os tenha.',
                        15, E'[]', E'B3_P20 == \'o-imovel-e-meu\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030880, 'displaytext', 'B3_P20_R67', E'Neste caso, você pode procurar uma delegacia, de preferência especializada no atendimento às mulheres, e solicitar uma medida protetiva para que o agressor seja afastado do ambiente doméstico e de você.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030900, 'displaytext', 'B3_P20_R69', E'Se julgar que sua saída é a única chance de romper o ciclo de violência, siga com o plano. Não é abandono de lar querer sobreviver.',
                        15, E'[]', E'B3_P20 == \'o-imovel-e-proprio-ou-alugado-em-nome-do-agressor\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030930, 'displaytext', 'B3_P20_R71', E'Neste caso, você pode procurar uma delegacia, de preferência especializada no atendimento às mulheres, e solicitar uma medida protetiva para que o agressor seja afastado do ambiente doméstico e de você.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030950, 'displaytext', 'B3_P20_R73', E'Deixar o lar não invalida a sua participação em possíveis divisões de bens ou no direito à guarda de filhos, caso os tenha.',
                        15, E'[]', E'B3_P20 == \'o-imovel-e-alugado-no-meu-nome\' ', null,
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10030970, 'displaytext', 'B3_P20_R74', E'Entendi! Você possui direitos nessa situação e eles devem ser respeitados nesse momento delicado. Saiba também que deixar o ambiente de violência não invalida a sua participação em possíveis divisões de bens ou o direito à guarda de filhos.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10032000, 'displaytext', 'B4_P21intro', E'O objetivo primeiro deste plano é garantir sua integridade física. Por isso, neste bloco vamos fazer perguntas sobre suas rotinas dentro e fora de casa, além de aspectos da convivência com o agressor que podem denotar o nível de risco ao qual você pode estar submetida. Reforçamos que as informações aqui compartilhadas permanecerão em sigilo, pois reconhecemos sua autonomia e capacidade para decidir sobre a própria realidade.',
                        16, E'[]', E'1', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10033000, 'yesno', 'B4_P21', E'Você mora com o agressor?',
                        16, E'[]', E'1', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10033010, 'displaytext', 'B4_P21_R77', E'Sabemos que, neste caso, você pode ser surpreendida com brigas e agressões.',
                        16, E'[]', E'B4_P21 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10033020, 'displaytext', 'B4_P21_R78', E'Quando situações de conflito forem inevitáveis, fique longe da cozinha, de objetos que possam ser usados para lhe machucar e de ambientes em que você possa ser presa pelo agressor. Se a situação se agravar, grite por socorro e/ou acione a Polícia Militar pelo 190.',
                        16, E'[]', E'B4_P21 == \'Y\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10033030, 'displaytext', 'B4_P21_R79', E'A violência doméstica é cíclica. Por isso, mesmo em momentos de aparente calmaria, mantenha seu plano em segredo.',
                        16, E'[]', E'B4_P21 == \'Y\' ', null,
                        null, '[{"codigo":"T7"},{"codigo":"T8"},{"codigo":"T57"},{"codigo":"T58"},{"codigo":"T59"},{"codigo":"T104"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10033040, 'displaytext', 'B4_P21_R80', E'Certo! Ainda assim é importante que você tenha muita atenção até conseguir executar o seu plano de fuga.',
                        16, E'[]', E'B4_P21 == \'N\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10033050, 'displaytext', 'B4_P21_R81', E'Não permita que o agressor acesse sua residência, mesmo que alegue boas intenções e que a situação pareça controlada.',
                        16, E'[]', E'B4_P21 == \'N\' ', null,
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10034050, 'yesno', 'B4_P22', E'Você já foi trancada em casa e ficou sem ter como sair ou se comunicar com outras pessoas?',
                        16, E'[]', E'B4_P21 == \'Y\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10034060, 'displaytext', 'B4_P22_R82', E'Sinto muito que você tenha sido submetida a essa violência. Prender alguém indevidamente e contra vontade é crime de cárcere privado, com pena prevista de 1 a 3 anos de reclusão. Devido a esse histórico, vou incluir em seu plano de fuga algumas orientações importantes para sua segurança pessoal.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10034070, 'displaytext', 'B4_P22_R83', E'Que bom! Mas, caso venha a acontecer, deixaremos você orientações específicas em seu plano de fuga para te auxiliar a sair ilesa dessa situação.',
                        16, E'[]', E'B4_P22 == \'N\' ', null,
                        null, '[{"codigo":"T11"},{"codigo":"T12"},{"codigo":"T23"},{"codigo":"T112"},{"codigo":"T113"},{"codigo":"T114"},{"codigo":"T115"},{"codigo":"T116"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10035070, 'yesno', 'B4_P23', E'O agressor costuma tomar/danificar seu celular e/ou monitorar suas ligações e mensagens?',
                        16, E'[]', E'B4_P22 == \'Y\' || B4_P22 == \'N\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10035080, 'displaytext', 'B4_P23_R84', E'Sinto muito por isso! Danificar objetos pessoais é um sinal de risco grave em casos de violência doméstica. Como esse plano não é para situação de emergência, caso esteja passando por isso no momento busque ajuda imediatamente. Acione alguém de sua confiança e/ou a Polícia Militar pelo telefone 190',
                        16, E'[]', E'B4_P23 == \'Y\' ', null,
                        null, '[{"codigo":"T20"},{"codigo":"T24"},{"codigo":"T117"},{"codigo":"T118"},{"codigo":"T119"},{"codigo":"T120"},{"codigo":"T121"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10035090, 'displaytext', 'B4_P23_R85', E'Está bem! Vamos seguir com as etapas do seu plano!',
                        16, E'[]', E'B4_P23 == \'N\' ', null,
                        null, '[{"codigo":"T20"},{"codigo":"T24"},{"codigo":"T117"},{"codigo":"T118"},{"codigo":"T119"},{"codigo":"T120"},{"codigo":"T121"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10036090, 'onlychoice', 'B4_P24', E'Você já denunciou o agressor e/ou tem medida protetiva contra ele?',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10036100, 'displaytext', 'B4_P24_R86', E'Que bom! Ter a medida protetiva é um grande passo, mas ainda assim é importante manter cuidados. Caso ele ainda tente contato ou lhe ameace, vá à Defensoria Pública ou entre em contato com o(a) advogado(a) particular para informar que a medida protetiva está sendo descumprida.',
                        16, E'[]', E'B4_P24 == \'sim-tenho-medida-protetiva\' ', null,
                        null, '[{"codigo":"T8"},{"codigo":"T122"},{"codigo":"T123"},{"codigo":"T124"},{"codigo":"T125"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10036110, 'displaytext', 'B4_P24_R87', E'É muto importante solicitar uma medida protetiva. Além de te afastar do ciclo de violência, ela é um meio legal de garantia de assistências e direitos, não importa quem seja o agressor (companheiro, pai, irmão, filho, outros)',
                        16, E'[]', E'B4_P24 == \'ja-denunciei-mas-nao-tenho-medida-protetiva\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10036120, 'displaytext', 'B4_P24_R88', E'A violência doméstica é cíclica e gradual, e os abusos tendem a piorar com o tempo. Não se intimide.',
                        16, E'[]', E'B4_P24 == \'ja-denunciei-mas-nao-tenho-medida-protetiva\' ', null,
                        null, '[{"codigo":"T8"},{"codigo":"T122"},{"codigo":"T123"},{"codigo":"T124"},{"codigo":"T125"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10036130, 'displaytext', 'B4_P24_R89', E'Infelizmente, existe um alto volume de desinformação circulando por aí. Mas saiba, medidas protetivas ajudam a salvar vidas.',
                        16, E'[]', E'B4_P24 == \'nunca-denunciei\' ', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10036140, 'displaytext', 'B4_P24_R90', E'Respeite o seu tempo. Quando se sentir preparada, vá até uma delegacia, de preferência especializada em atendimento à mulher, denuncie o agressor e solicite medida protetiva.',
                        16, E'[]', E'B4_P24 == \'nunca-denunciei\' ', null,
                        null, '[{"codigo":"T8"},{"codigo":"T122"},{"codigo":"T123"},{"codigo":"T124"},{"codigo":"T125"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10037140, 'onlychoice', 'B4_P25', E'O agressor tem acesso a arma de fogo?',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10037150, 'displaytext', 'B4_P25_R91', E'Entendi! Nesse caso, é importante ressaltar que a arma só pode ser usada na necessidade de exercer atividade profissional de risco. Caso ele esteja usando a arma para intimidar e ameaçar, não deixe de avisar a quem confia e às autoridades competentes. Sua proteção é prioridade!',
                        16, E'[]', E'B4_P25 == \'sim-a-atividade-profissional-autoriza-a-posse\' ', null,
                        null, '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T126"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10037160, 'displaytext', 'B4_P25_R92', E'Entendi! Ter arma em casa é um fator de risco. Prezando sua segurança, é importante que comunique a pessoas de confiança e às autoridades para que sua vida esteja em proteção.',
                        16, E'[]', E'B4_P25 == \'sim-mas-nao-sei-a-procedencia-e_ou-nao-e-registrada\' ', null,
                        null, '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T126"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10037170, 'displaytext', 'B4_P25_R93', E'Siga com o planejamento. Se em outro momento você desejar orientações específicas sobre essa questão, nossa equipe estará à disposição no Suporte PenhaS.',
                        16, E'[]', E'B4_P25 == \'nao-ou-nao-sei\' ', null,
                        null, '[{"codigo":"T9"},{"codigo":"T10"},{"codigo":"T11"},{"codigo":"T126"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10038170, 'yesno', 'B4_P26', E'Você possui alguma deficiência física e/ou intelectual?',
                        ...
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10038180, 'displaytext', 'B4_P26_R94', E'Ta bem! A depender da situação, e só você pode avaliar, talvez você necessite da ajuda de alguém de confiança antes, durante e depois da fuga. Avalie quem pode estar com você durante esse processo.',
                        16, E'[]', E'B4_P26 == \'Y\' ', null,
                        null, '[{"codigo":"T94"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10038190, 'displaytext', 'B4_P26_R95', E'Até que a fuga seja efetivada, mantenha a rotina de medicações (se houver) e cuidados.',
                        16, E'[]', E'B4_P26 == \'Y\' ', null,
                        null, '[{"codigo":"T23"},{"codigo":"T73"},{"codigo":"T74"},{"codigo":"T127"},{"codigo":"T128"}]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10039190, 'yesno', 'B4_P27', E'Você está grávida?',
                        16, E'[]', E'B4_P26 == \'Y\' || B4_P26 == \'N\'', null,
                        null, '[]', null, '[]');
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10039200, 'displaytext', 'B4_P27_R96', E'Sinta-se acolhida e encorajada a encontrar um local seguro.',
...
INSERT INTO quiz_config(status, sort, type, code, question, questionnaire_id, intro, relevance, button_label, options, tarefas, change_to_questionnaire_id, tag)
                        VALUES ('published', 10040230, 'botao_fim', 'BF_P999', E'Parabens, você concluiu o manual de fuga, agora voce será levada para XPTO',
                        18, E'[]', E'1', 'Ok!',
                        null, '[]', null, '[]');
